    ...
    <div class='overview-inner'>
        <div class='template-info gradient clearfix'>
            ...
            <div class='live-update gradient'>
                ...
                <p>
                    <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=CB5YWUK8JZ632" target="_blank">
                        <img src="https://www.paypalobjects.com/en_US/i/btn/btn_donateCC_LG.gif" alt="PayPal - The safer, easier way to pay online!" style="float:none; margin: 15px 0 0 50px !important; border:none;" />
                    </a>
                </p>
