...
#browser {height:320px;width:100%;overflow:auto;position:relative;margin:20px 0 20px 0}
#browser a {
...
?>
<form action="index.php" name="adminForm" id="adminForm" method="post" enctype="multipart/form-data" style="margin:0px">
	<fieldset>
		<div class="well" style="margin:0px">
			...
			<div class="btn-toolbar pull-right" style="margin:0px">
				<button type="button" class="btn" onclick="javascript:document.adminForm.layout.value='grid';document.adminForm.submit();">
